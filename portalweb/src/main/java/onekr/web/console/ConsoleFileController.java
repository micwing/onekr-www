...
public class ConsoleFileController extends BaseController {
    ...
    public String doUploadFile2(MultipartFile file) throws Exception{       
	...
	public ModelAndView list(String dir) {
		ModelAndView mav = new ModelAndView(CONSOLE+"file-list");
		if (StringUtils.isEmpty(dir)) {
			dir = fileUploadDir;
		}
		//检查目录
	...
	public ModelAndView add() {
		ModelAndView mav = new ModelAndView(CONSOLE+"file-add");
		return mav;
	}
	...
	public void doUploadFile(
		...
		//文件保存目录URL
		String saveUrl  = request.getContextPath() + fileManagerUrl;
	...
	public void fileManager(
		...
		String rootUrl  = request.getContextPath() + fileManagerUrl;
